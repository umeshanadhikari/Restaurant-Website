     ...
     <div class="col-lg-4 col-md-6 col-sm-8">
       ...
       <?php while($row = $result->fetch_assoc()){ ?>
        ...
        <table class="table table-borderless">
            <tr>
            <tr><th> Name -</th> <td><?php echo $row['res_name']; ?></td></tr> 
            <tr><th> Email -</th> <td><?php echo $row['res_email']; ?></td></tr> 
            <tr><th> Password -</th> <td><?php echo $row['res_password']; ?></td></tr> 
            <tr><th> Res. Number -</th> <td><?php echo $row['res_number']; ?></td></tr> 
            <tr><th> Res. City -</th> <td><?php echo $row['res_city']; ?></td></tr> 
            </tr>
            </table>
          </div>
          <div class="card-footer text-right"><a href="edit-res-profile.php?edit=<?php echo $row['id']; ?>" class="btn btn-lg btn-info"> Edit </a> </div>
      </div>
     <?php } ?>
</div>
</div>
